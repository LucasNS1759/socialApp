...
const PublicationContainer = ({ post, setCurrentView }) => {
    ...
    <>
     {post?.post && (
      ...
      >
        ...
        {/* parrafo de texto de la publicacion que se ajusta al limite establecido para mostrarse en el feed break-all ??*/}
        <p
          onClick={() => setCurrentView({ type: "thread", id: post?.id })}
          className="mt-4 text-center mx-auto  cursor-pointer text-xl"
